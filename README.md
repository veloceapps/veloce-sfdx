...
veloce-sfdx/1.0.67 darwin-x64 node-v16.13.0
$ sfdx --help [COMMAND]
USAGE
  $ sfdx COMMAND
...
...
* [`sfdx veloce:load -s <string> -i <string> -f <string> -I <string> [-R <string>] [-P] [-U] [-o <string>] [-b <string>] [-v <string>] [-u <string>] [--apiversion <string>] [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`](#sfdx-veloceload--s-string--i-string--f-string--i-string--r-string--p--u--o-string--b-string--v-string--u-string---apiversion-string---json---loglevel-tracedebuginfowarnerrorfataltracedebuginfowarnerrorfatal)
...
* [`sfdx veloce:packrulesgroup -i <string> -o <string> [-P <string>] [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`](#sfdx-velocepackrulesgroup--i-string--o-string--p-string---json---loglevel-tracedebuginfowarnerrorfataltracedebuginfowarnerrorfatal)
...
_See code: [lib/commands/veloce/apexload.js](https://github.com/veloceapps/veloce-sfdx/blob/v1.0.67/lib/commands/veloce/apexload.js)_
...
_See code: [lib/commands/veloce/dump.js](https://github.com/veloceapps/veloce-sfdx/blob/v1.0.67/lib/commands/veloce/dump.js)_
...
_See code: [lib/commands/veloce/dumpcontentdoc.js](https://github.com/veloceapps/veloce-sfdx/blob/v1.0.67/lib/commands/veloce/dumpcontentdoc.js)_
...
_See code: [lib/commands/veloce/dumpdoc.js](https://github.com/veloceapps/veloce-sfdx/blob/v1.0.67/lib/commands/veloce/dumpdoc.js)_
...
USAGE
  $ sfdx veloce:load -s <string> -i <string> -f <string> -I <string> [-R <string>] [-P] [-U] [-o <string>] [-b <string>] 
...
_See code: [lib/commands/veloce/load.js](https://github.com/veloceapps/veloce-sfdx/blob/v1.0.67/lib/commands/veloce/load.js)_
...
_See code: [lib/commands/veloce/loadcontentdoc.js](https://github.com/veloceapps/veloce-sfdx/blob/v1.0.67/lib/commands/veloce/loadcontentdoc.js)_
...
_See code: [lib/commands/veloce/loaddoc.js](https://github.com/veloceapps/veloce-sfdx/blob/v1.0.67/lib/commands/veloce/loaddoc.js)_
...
_See code: [lib/commands/veloce/login.js](https://github.com/veloceapps/veloce-sfdx/blob/v1.0.67/lib/commands/veloce/login.js)_
...
_See code: [lib/commands/veloce/packconfig.js](https://github.com/veloceapps/veloce-sfdx/blob/v1.0.67/lib/commands/veloce/packconfig.js)_
...
_See code: [lib/commands/veloce/packpricelist.js](https://github.com/veloceapps/veloce-sfdx/blob/v1.0.67/lib/commands/veloce/packpricelist.js)_
...
_See code: [lib/commands/veloce/packrules.js](https://github.com/veloceapps/veloce-sfdx/blob/v1.0.67/lib/commands/veloce/packrules.js)_
...
USAGE
  $ sfdx veloce:packrulesgroup -i <string> -o <string> [-P <string>] [--json] [--loglevel 
  trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]
...
_See code: [lib/commands/veloce/packrulesgroup.js](https://github.com/veloceapps/veloce-sfdx/blob/v1.0.67/lib/commands/veloce/packrulesgroup.js)_
...
OPTIONS
  ...
  -P, --pricelistid=pricelistid                                                     replace ALL references to pricelists
                                                                                    in model with this ID
...
_See code: [lib/commands/veloce/packui.js](https://github.com/veloceapps/veloce-sfdx/blob/v1.0.67/lib/commands/veloce/packui.js)_
...
_See code: [lib/commands/veloce/permgen.js](https://github.com/veloceapps/veloce-sfdx/blob/v1.0.67/lib/commands/veloce/permgen.js)_
...
_See code: [lib/commands/veloce/sort.js](https://github.com/veloceapps/veloce-sfdx/blob/v1.0.67/lib/commands/veloce/sort.js)_
<!-- commandsstop -->
